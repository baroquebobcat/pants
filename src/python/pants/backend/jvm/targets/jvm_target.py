...
class JvmTarget(Target, Jarable):
  ...
  def __init__(self,
    ...
    :param str runtime_platform: The name of the platform (defined under the jvm-platform subsystem) to use
                         ...
                         dictionary). If unspecified, the platform will default to the first one of
                         these that exist: (1) the platform for the target
                         (2) the default_runtime_platform specified for jvm-platform, (3) the
                         platform that would be used for the platform kwarg.
